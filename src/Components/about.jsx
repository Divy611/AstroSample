...
import { VALUES, TEAM, MILESTONES, WHATSAPP_URL, GRAHAS, DIRECTIONS, CHAKRAS, GRADIENT_PRIMARY } from './values';
    ...
    return (
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 60px 1fr', alignItems: 'start', marginBottom: 0 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                <motion.div whileHover={{ scale: 1.3, boxShadow: '0 0 20px rgba(167,139,250,0.5)' }} style={{ width: '16px', height: '16px', borderRadius: '50%', flexShrink: 0, background: GRADIENT_PRIMARY, border: '3px solid #faf9f7', boxShadow: '0 0 10px rgba(167,139,250,0.35)', zIndex: 1, marginTop: '0.35rem' }} />
