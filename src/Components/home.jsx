...
function StarField() {
    ...
    return (
        <div style={{ position: 'absolute', inset: 0, overflow: 'hidden', pointerEvents: 'none' }}>
            {stars.map((s) => (
                <motion.div key={s.id} animate={{ opacity: [0.1, 0.8, 0.1] }} transition={{ duration: s.duration, delay: s.delay, repeat: Infinity, ease: 'easeInOut' }} style={{
    ...
    return (
        ...
        >
            ...
            <motion.div whileHover={{ x: 4 }} style={{
                marginTop: '1.25rem', color: '#c084fc', fontSize: '0.85rem',
    ...
    return (
        <div style={{ background: '#050212', minHeight: '100vh', color: '#e2d9f3', fontFamily: "'Inter', sans-serif", overflowX: 'hidden' }}>
            <motion.section ref={heroRef} style={{
                opacity: heroOpacity, position: 'relative',
            ...
            >
                ...
                <motion.div ref={orbRef} style={{
                    ...
                    background: 'radial-gradient(ellipse, rgba(124,58,237,0.22) 0%, rgba(192,132,252,0.06) 50%, transparent 70%)',
                    pointerEvents: 'none', y: orbY,
                }}
                />
                <div style={{
                ...
                <div style={{
                    ...
                    padding: '8rem 1.5rem 4rem', maxWidth: '800px', margin: '0 auto',
                }}>
                    <motion.div initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.6, ease: 'backOut' }} style={{
                    ...
                    <h1 ref={titleRef} style={{
                        ...
                        <span style={{
                            background: 'linear-gradient(135deg, #ffffff 30%, #c084fc 70%, #7c3aed)',
                    ...
                    <p ref={subtitleRef} style={{
                        ...
                        color: 'rgba(200,185,230,0.7)', maxWidth: '580px',
                        margin: '0 auto 2.5rem', fontWeight: 400,
                    }}
                    >Unlock the profound wisdom of Vedic Astrology, Numerology & Vastu Shastra — crafted by master practitioners for your unique cosmic journey.
                    </p>
                ...
                <motion.div animate={{ y: [0, 8, 0] }} transition={{ duration: 2, repeat: Infinity, ease: 'easeInOut' }} style={{
                    ...
                    color: 'rgba(192,132,252,0.5)', fontSize: '0.7rem', letterSpacing: '0.1em',
                    pointerEvents: 'none',
                }}
                >
                    <span>SCROLL</span>
                ...
                <div style={{
                    ...
                    {STATS.map((s) => (
                        <div key={s.label} className="stat-item">
                            ...
                            <div style={{
                                color: 'rgba(200,185,230,0.55)', fontSize: '0.825rem',
            ...
            <section style={{ padding: '7rem 1.5rem', maxWidth: '1280px', margin: '0 auto' }}>
                <div className="reveal-up" style={{ textAlign: 'center', marginBottom: '4rem' }}>
                    ...
                    <h2 style={{
                        ...
                        WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent',
                        marginBottom: '1rem',
                    }}>Sacred Sciences, Modern Guidance</h2>
                    <p style={{
                        color: 'rgba(200,185,230,0.6)', fontSize: '1rem',
                        maxWidth: '520px', margin: '0 auto', lineHeight: 1.75,
                    }}>Each service is rooted in millennia of Vedic tradition, delivered with contemporary precision.
                    </p>
                </div>
            ...
            <section style={{ padding: '7rem 1.5rem' }}>
                <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
                    <div className="reveal-up" style={{ textAlign: 'center', marginBottom: '4rem' }}>
                        ...
                        <h2 style={{
                            fontSize: 'clamp(1.75rem, 4vw, 3rem)', fontWeight: 800, fontFamily: "'Cormorant Garamond', serif", background: 'linear-gradient(135deg, #fff, #c084fc)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent',
                        }}>Voices of Transformation</h2>
                    </div>
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1.5rem' }}>
                        {TESTIMONIALS.map((t) => (
            ...
            <section style={{ padding: '5rem 1.5rem' }}>
                <div className="reveal-up" style={{ maxWidth: '820px', margin: '0 auto' }}>
                    <motion.div whileHover={{ boxShadow: '0 30px 80px rgba(124,58,237,0.35)' }} transition={{ duration: 0.3 }} style={{
                        background: 'linear-gradient(135deg, rgba(124,58,237,0.3), rgba(192,132,252,0.12))',
                    ...
                    >
                        ...
                        <h2 style={{
                            ...
                            WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent',
                            marginBottom: '1rem',
                        }}>Your Stars Are Aligned</h2>
                        <p style={{
                            color: 'rgba(200,185,230,0.65)', fontSize: '1rem', lineHeight: 1.75,
                            marginBottom: '2.5rem', maxWidth: '480px', margin: '0 auto 2.5rem',
                        }}>
                            Take the first step toward clarity. Book a personalized session with one of our
                            master Vedic practitioners today.
                        </p>
