        ...
        <motion.div ref={panelRef} key={service.id} variants={panelVariants} initial="hidden" animate="visible" exit="exit" style={{
            ...
            <motion.div variants={panelChildVariants} style={{ display: 'flex', alignItems: 'center', gap: '1.2rem', marginBottom: '1.75rem' }}>
                <div style={{
                    ...
                    background: `linear-gradient(135deg, ${service.accentColor}22, ${service.accentColor}0a)`,
                    border: `1.5px solid ${service.accentColor}33`,
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                    fontSize: '2.2rem',
                    filter: `drop-shadow(0 4px 12px ${service.glowColor})`,
                }}>{service.icon}</div>
                <div>
                    <h3 style={{
                        color: '#2d2438', fontSize: 'clamp(1.4rem, 3vw, 2rem)',
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '2rem' }}>
                ...
                <motion.div variants={panelChildVariants} style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
                    ...
                    <div style={{ padding: '1.75rem', background: 'rgba(255,255,255,0.75)', border: '1.5px solid rgba(167,139,250,0.18)', borderRadius: '18px', backdropFilter: 'blur(8px)' }}>
                        ...
                        <motion.button whileHover={{ scale: 1.03, boxShadow: `0 8px 28px ${service.glowColor}` }} whileTap={{ scale: 0.97 }} style={{
                            width: '100%', padding: '0.8rem',
                            background: `linear-gradient(135deg, ${service.accentColor}, ${service.accentColor}bb)`,
                            border: 'none', borderRadius: '12px',
                            color: '#fff', fontSize: '0.9rem', fontWeight: 700,
                            cursor: 'pointer', letterSpacing: '0.04em',
                        }}
                        >Book This Service →</motion.button>
                    </div>
                </motion.div>
            </div>
        </motion.div>
    ...
    return (
        <div style={{ background: '#faf9f7', minHeight: '100vh', color: '#2d2438', fontFamily: "'Inter', sans-serif", overflowX: 'hidden' }}>
            ...
            <section ref={processRef} style={{
                padding: '7rem 1.5rem',
                background: 'linear-gradient(180deg, transparent, rgba(245,240,255,0.7), transparent)',
                ...
                <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
                    ...
                    <div style={{
                        ...
                        {PROCESS_STEPS.map((step, i) => (
                            <motion.div key={step.num} className="process-step" whileHover={{ background: 'rgba(245,240,255,0.95)' }} transition={{ duration: 0.25 }} style={{
                                padding: '2.5rem 2rem',
                                background: '#ffffff',
                                position: 'relative',
                            }}
                            >
                                <div style={{
                                    ...
                                    fontFamily: "'Cormorant Garamond', serif",
                                    background: 'linear-gradient(135deg, rgba(167,139,250,0.35), rgba(196,181,253,0.15))',
                                    WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent',
            ...
            <section style={{ padding: '0 1.5rem 8rem' }}>
                <div className="reveal-up" style={{ maxWidth: '820px', margin: '0 auto' }}>
                    <motion.div whileHover={{ boxShadow: '0 30px 80px rgba(124,92,191,0.15)' }} transition={{ duration: 0.3 }} style={{
                        ...
                        boxShadow: '0 20px 60px rgba(124,92,191,0.07)',
                    }}>
                        ...
                        <motion.div animate={{ rotate: [0, 10, -10, 0] }} transition={{ duration: 5, repeat: Infinity, ease: 'easeInOut' }} style={{
                            fontSize: '2.8rem', marginBottom: '1rem', display: 'inline-block',
                        ...
                        <p style={{ color: '#6b5c8a', fontSize: '0.97rem', lineHeight: 1.8, maxWidth: '440px', margin: '0 auto 2.25rem' }}>Book a free 20-minute discovery call. We'll understand your situation and recommend the most relevant service for you — no obligation, no pressure.
                        </p>
                        ...
                        >Book Free Discovery Call ✦</motion.button>
                    </motion.div>
                </div>
            </section>
        </div>
